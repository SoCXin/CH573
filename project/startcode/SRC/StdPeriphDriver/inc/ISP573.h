...
#define EEPROM_MIN_ER_SIZE  EEPROM_PAGE_SIZE          // Flash-ROM & Data-Flash minimal size for erasing
...
/* LockFlag: 0=unlock all, 1=lock boot code, 3=lock all code and data */
