package cn.wch.ch573update.scan;
...
import cn.wch.ch573update.R;
import cn.wch.ch573update.scan.ui.DeviceAdapter;
...
public class ScanActivity extends ScanBaseActivity {
    ...
    void startScan(){
        ...
        try {
            CH573BluetoothManager.getInstance().startScan(scanResult);
    ...
    void stopScan(){
        ...
        try {
            CH573BluetoothManager.getInstance().stopScan();
        } catch (BLELibException e) {
            e.printStackTrace();
        }
        invalidateOptionsMenu();
    ...
    cn.wch.blelib.ch573.callback.ScanResult scanResult=new cn.wch.blelib.ch573.callback.ScanResult() {
        @Override
