...
public class ScanActivity extends ScanBaseActivity {
    ...
    void startScan(){
        ...
        try {
            CH583BluetoothManager.getInstance().startScan(scanResult);
    ...
    void stopScan(){
        ...
        try {
            CH583BluetoothManager.getInstance().stopScan();
        } catch (BLELibException e) {
            e.printStackTrace();
        }
        invalidateOptionsMenu();
    ...
    cn.wch.blelib.ch583.callback.ScanResult scanResult=new cn.wch.blelib.ch583.callback.ScanResult() {
        @Override
