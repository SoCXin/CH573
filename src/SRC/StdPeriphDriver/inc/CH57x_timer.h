...
void TMR1_DMACfg( FunctionalState s, UINT16 startAddr, UINT16 endAddr, DMAModeTypeDef m );    /* DMA配置  */
...
void TMR2_DMACfg( FunctionalState s, UINT16 startAddr, UINT16 endAddr, DMAModeTypeDef m );    /* DMA配置  */
