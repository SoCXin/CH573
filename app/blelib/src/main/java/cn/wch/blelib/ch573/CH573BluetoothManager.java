...
import cn.wch.blelib.ch573.callback.NotifyStatus;
import cn.wch.blelib.ch573.callback.RSSIStatus;
import cn.wch.blelib.ch573.callback.ScanResult;
...
//CH573没有固定广播包，不需要过滤
public class CH573BluetoothManager {
    private Application application;
    private static CH573BluetoothManager ch573BluetoothManager;
     ...
     * @return 返回全局唯一单例
     */
    public static CH573BluetoothManager getInstance() {
        if(ch573BluetoothManager ==null){
            synchronized (CH573BluetoothManager.class){
                ch573BluetoothManager =new CH573BluetoothManager();
            }
        }
        return ch573BluetoothManager;
    }
